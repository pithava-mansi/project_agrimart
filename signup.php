    ...
    <div class="container-fluid ">
        ...
        <div class="row  d-flex  justify-content-center  mt-3">
            <div class="col-md-4  col-sm-12">
                ...
                <form class="mt-3 aline-item-center form mb-3  p-2" action="" method="POST">
                <div class="text text-center text-dark">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="fname" class=" m-1 p-2" placeholder="Name">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text m-1 p-2" id="basic-addon1"><i
                                class="bi bi-person-circle"></i></span>
                        <input type="text" name="lname" class="m-1 p-2" placeholder="Surname">
                    </div>
                    <div class="input-group mb-3">
